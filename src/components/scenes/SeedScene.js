...
class SeedScene extends Scene {
    constructor(width, height) {
        ...
        this.width = width;
        this.height = height;
        this.allPositions = new PositionFinder(-1 * (this.width - 2), this.width - 2);
        ...
        // let json = JSON.parse('exampleSong.json');
        // console.log(json);
        ...
        for (let i = 0; i < info.length; i = i + 90) {
            ...
            setTimeout(noteToLetter, parseInt(info[i]) - fallTime, this, letters, noteToColor[note]);
        }
